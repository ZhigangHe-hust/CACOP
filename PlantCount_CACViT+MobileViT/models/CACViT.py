...
from models.Block.Blocks import Block, MobileViTLikeBlock, MobileViTBlock, LightweightMobileViTBlock,UltraLightweightMobileViTBlock, MinimalMobileViTBlock
...
class SupervisedMAE(nn.Module):
    ...
    def __init__(self, img_size=384, patch_size=16, in_chans=3, 
        ...
        UltraLightweightMobileViTBlock(embed_dim, num_heads, num_patches, mlp_ratio, qkv_bias=True, qk_scale=None, norm_layer=norm_layer)
        ...
        self.decoder_blocks = nn.ModuleList([
            MinimalMobileViTBlock(decoder_embed_dim, decoder_num_heads, num_patches, mlp_ratio, qkv_bias=True, qk_scale=None, norm_layer=norm_layer)
