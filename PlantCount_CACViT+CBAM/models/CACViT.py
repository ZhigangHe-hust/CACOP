...
class SupervisedMAE(nn.Module):
    ...
    def __init__(self, img_size=384, patch_size=16, in_chans=3, 
        ...
        self.cbam = CBAM(256)
        self.final_conv = nn.Conv2d(256, 1, kernel_size=1, stride=1)
        ## Regressor
    ...
    def Regressor(self, feature):
        ...
        feature_256ch = self.decode_head3(feature)
        feature_256ch_attended = self.cbam(feature_256ch)
        feature_1ch = self.final_conv(feature_256ch_attended)

        feature = F.interpolate(
                                feature_1ch, size=feature.shape[-1]*2, mode='bilinear', align_corners=False)
