...
parser.add_argument("-m",  "--model_path", type=str, default="./logsSave_ours_lr_5_147/FamNet.pth", help="path to trained model")
...
print('On {} data, MAE: {:6.2f}, rMAE: {:7.4f}, RMSE: {:6.2f}, rRMSE: {:7.4f}, R²: {:7.4f}'.format(args.test_split, mae, rmae, rmse, rrmse, r2))
